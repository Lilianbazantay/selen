...
LDFLAGS +=  -lSDL2_image -lSDL2_ttf -lusp10 -lrpcrt4 -L. -lselen

default: src/main.c libselen.a
	$(CC) $(CFLAGS) src/main.c $(INCLUDE) $(LDFLAGS) -o Selen.exe

libselen.a: bld bld/global.o bld/title.o bld/gameplay.o
	ar -rcs libselen.a bld/global.o bld/title.o bld/gameplay.o
